...
public class ProjectServiceTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {
            "1,Test Project 1,Just Testing,2,,6",
            "2,Test Project 2,Just Testing,3,,12",
            "3,Test Project 3,Just Testing,2,,18",
    })
    ...
    @ValueSource(strings = {
            ...
            "4,Doctor Help,Clinick Management System,2,20220510,6,Aung Aung,aungaung",
            "5,Order Me,Order Management System,2,20220510,18,Aung Aung,aungaung",
            "6,The Movies,Movies Informations Provider,3,20220510,6,Aung Naing,aungnaing"
    })
    void should_found_with_id(String csv) {
        ...
        result.setManagerId(dto.getManagerId());
        result.setManagerName(dto.getManagerName());
        result.setManagerLogin(dto.getManagerLogin());
